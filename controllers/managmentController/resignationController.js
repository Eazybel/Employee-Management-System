...
const resignationController=async(req,res)=>{
 const companyData=await Company.findOne({companyUID:req.body.companyUID})
    ...
    myEmployee.resignation.unshift({resigner:req.body.employeeName,noticeDate:req.body.noticeDay,lastDate:req.body.lastDay,reason:req.body.reason,ongoingStatus:true,acceptanceStatus:false})
