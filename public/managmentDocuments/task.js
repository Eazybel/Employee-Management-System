...
// Start from here nextt by changing the if statment code block because it is not working it is unrelayable {#49e,5}
if (
  data[i].task.length !== 0 &&
  data[i].task.some(t => t.status === "active" && new Date(t.dueDate) > new Date())
