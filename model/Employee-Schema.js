...
const EmployeeSchema = new mongoose.Schema({
  ...
  task:[{assignedPerson:{type:String},taskName:{type:String},dueDate:{type:String},priorityLevel:{type:String},description:{type:String},taskID:{type:String},status:{type:String},logDate:{type:String}}]
}, {
